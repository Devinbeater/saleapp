...
-- This script creates the necessary tables in the postgres database
...
DROP TRIGGER IF EXISTS update_daily_sheets_updated_at ON daily_sheets;
...
DROP TRIGGER IF EXISTS update_denominations_updated_at ON denominations;
